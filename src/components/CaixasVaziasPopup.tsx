...
import ErrorPopup from "./popups/CompErrorPopup";
import SuccessPopup from "./popups/CompSuccessPopup";
import successSound from '../sounds/success.mp3';
import { apiPallets, apiLog, apiVzias } from "../lib/axios";
import { useLocation, } from "react-router-dom";

import type { Carga } from "../types/carga.ts";
import type { Pallet, PalletApi, CaixasVazias, VaziaItem} from "../types/pallet.ts";

Modal.setAppElement("#root");

export default function CaixasVaziasPopup({ message, matricula, onClose, palletIndex }: CaixasVazias) {
